...
CONFIDENCE_THRESHOLD_MULTIPLE = 75  # عتبة الإشارات المتعددة
MIN_STRATEGY_CONFIDENCE = 30  # أقل ثقة للاستراتيجيات المحتسبة
    ...
    def create_strategy_analysis_report(self, analysis_report: Dict[str, Any]) -> str:
        ...
        try:
            ...
            for coin_key, coin_analysis in analysis_report['coin_analysis'].items():
                ...
                # return message يجب أن يكون هنا بعد إكمال بناء الرسالة

                message += f"🎯 **الإشارة النهائية:** ⚪ **لا توجد إشارة واضحة**\n"

            return message  # هذا مكان return الصحيح
